        ...
        <div className="min-h-screen bg-white" style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px' }}>
            ...
            <main>
                ...
                <div className="mx-auto px-4 lg:px-12 pt-4">
                    ...
                    <p className="text-gray-600" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px', fontWeight: '400' }}><TranslatedText text="By using Bazingo, you agree to the following terms and conditions." /></p>
                </div>
