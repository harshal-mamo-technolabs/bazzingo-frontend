            ...
            <main>
                ...
                <div className="max-w-[1400px] mx-auto px-4 md:px-5" style={{ paddingTop: '28px', paddingBottom: '20px' }}>
                    <div className="flex items-center" style={{ marginBottom: '8px' }}>
                        ...
                        <h2 className="text-gray-900" style={{ fontSize: '16px', fontWeight: '600' }}>Terms of Use</h2>
                    </div>
                    <p className="text-gray-600" style={{ fontSize: '11px' }}>By using Bazingo, you agree to the following terms and conditions.</p>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 md:px-5">
                    <div className="max-w-[800px]">
                        ...
                        <div style={{ marginBottom: '24px' }}>
                            <h3 className="text-gray-900" style={{ fontSize: '11px', fontWeight: '600', marginBottom: '12px' }}>1. User Agreement:</h3>
                        ...
                        {/* Section 2 */}
                        <div style={{ marginBottom: '24px' }}>
                            <h3 className="text-gray-900" style={{ fontSize: '11px', fontWeight: '600', marginBottom: '12px' }}>2. Platform Usage:</h3>
                            <p className="text-gray-600" style={{ fontSize: '11px', lineHeight: '1.5' }}>
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the
                                1500s, when an unknown printer took a galley of type and scrambled it to
