    ...
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-4 border-blue-600 rounded-lg p-8 max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        <div className="flex justify-center items-center gap-4 mb-4">
          ...
          <h2 className="text-3xl font-bold text-blue-900"><TranslatedText text="Mission Complete!" /></h2>
          <span className="text-4xl">⚓</span>
        </div>
        <p className="text-blue-700 text-lg">
          <TranslatedText text="You have successfully navigated the Croatian Adriatic waters!" />
        </p>
      </div>
      ...
      <div className="text-center mb-8">
        <div className={`inline-flex items-center gap-3 bg-gradient-to-r ${getRankColor(rank)} text-white px-8 py-4 rounded-full shadow-lg`}>
          {getRankIcon(rank)}
          <div>
            <div className="text-sm font-medium opacity-90"><TranslatedText text="Codebreaker Rank" /></div>
            <div className="text-2xl font-bold"><TranslatedText text={rank} /></div>
          </div>
        </div>
        <p className="text-blue-700 mt-4 italic">
          <TranslatedText text={getRankMessage(rank)} />
        </p>
      </div>
      ...
      <div className="bg-white border-2 border-blue-400 rounded-lg p-6 mb-6">
        <div className="text-center">
          ...
          <div className="text-blue-800 font-semibold"><TranslatedText text="Final Score" /></div>
          <div className="text-sm text-gray-600 mt-1"><TranslatedText text="out of 200 points" /></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-green-100 border-2 border-green-400 rounded-lg p-4 text-center">
          ...
          <div className="text-green-600 text-sm"><TranslatedText text="Puzzles Solved" /></div>
          <div className="text-xs text-gray-600"><TranslatedText text="out of" /> {totalPuzzles}</div>
        </div>
        ...
        <div className="bg-yellow-100 border-2 border-yellow-400 rounded-lg p-4 text-center">
          ...
          <div className="text-yellow-600 text-sm"><TranslatedText text="Hints Used" /></div>
          <div className="text-xs text-gray-600"><TranslatedText text="navigation aids" /></div>
        </div>
        ...
        <div className="bg-red-100 border-2 border-red-400 rounded-lg p-4 text-center">
          ...
          <div className="text-red-600 text-sm"><TranslatedText text="Wrong Attempts" /></div>
          <div className="text-xs text-gray-600"><TranslatedText text="navigation errors" /></div>
        </div>
        ...
        <div className="bg-blue-100 border-2 border-blue-400 rounded-lg p-4 text-center">
          ...
          <div className="text-blue-600 text-sm"><TranslatedText text="Islands Explored" /></div>
          <div className="text-xs text-gray-600"><TranslatedText text="Croatian coastline" /></div>
        </div>
      </div>
      ...
      <div className="bg-amber-50 border-2 border-amber-400 rounded-lg p-4 mb-6">
        <h3 className="font-bold text-amber-800 mb-3 flex items-center gap-2">
          ...
          <TranslatedText text="Islands Successfully Explored" />
        </h3>
          ...
          {completedIslands.map((island, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-sm font-semibold text-amber-700">
                <TranslatedText text={island === 'Easy' ? 'Pag' : island === 'Moderate' ? 'Hvar' : 'Brač'} />
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bg-stone-100 border-2 border-stone-400 rounded-lg p-4 text-center">
        <div className="text-stone-700 text-sm italic">
          <TranslatedText text="The Croatian coast has been a crossroads of civilizations for millennia. From Roman emperors to Venetian merchants, many have used codes to protect their secrets along these ancient trade routes." />
        </div>
        <div className="text-xs text-stone-500 mt-2">
          - <TranslatedText text="Maritime History of the Adriatic" />
        </div>
      </div>
    </div>
  );
