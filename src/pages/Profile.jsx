...
const Profile = () => {
  ...
  // Base settings array (always visible)
  const baseSettings = [
  ...
  // Conditional profile pages based on visibility controls
  const profilePages = [
    { 
  ...
  // Filter profile pages based on visibility controls
  const visibleProfilePages = profilePages.filter(page => 
    isProfilePageVisible(page.pageKey)
  );

  // Combine base settings with visible profile pages
