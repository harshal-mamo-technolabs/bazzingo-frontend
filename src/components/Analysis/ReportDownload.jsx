...
const Report = React.forwardRef(({
  ...
  const total = scoreDataToUse?.totalScore || 0;
  const outOfScore = scoreDataToUse?.outOfScore || totalQuestions;
  
  return (
    <div ref={ref} className="bg-white text-black max-w-[850px] mx-auto shadow print:shadow-none print:w-[210mm] print:min-h-[297mm]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border rounded p-4 flex flex-col gap-2 text-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">{total} / {outOfScore}</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">{correctAnswers} / {Math.round(outOfScore / 5)}</span>
            </div>
          </div>
        </div>
      ...
      <div className="p-6 pt-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="border rounded p-4"><div className="text-gray-500">Total Score</div><div className="text-lg font-semibold">{total} / {outOfScore}</div></div>
