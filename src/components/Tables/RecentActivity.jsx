      ...
      <table className="w-full table-fixed border-separate border-spacing-y-4">
        ...
        <tbody>
          {activities.map(({ icon, alt, label, complete, pct, statusType, iconBg }, idx) => (
            <tr key={idx} className="bg-[#F2F5F6] rounded-xl overflow-hidden">
              ...
              <td className="py-4 px-6 text-center rounded-r-xl">
                {statusType === 'completed' ? (
                  ...
                  <button className="bg-orange-50 text-orange-500 border border-orange-300 hover:bg-orange-100 px-4 py-2 rounded-md text-sm font-medium transition-colors">
                    Resume
                  </button>
                )}
              </td>
